...
public class MenuController {
	...
	//http://localhost:8080/CloudringAD/admin/menu/listMenu.do
	@RequestMapping(value = "/listMenu")
	public String listMenu(HttpServletRequest request, HttpServletResponse response, ModelMap model) throws IOException {
...
//				}
		...
		return listMenu(request, response, model);//刷新菜单页面
	}
