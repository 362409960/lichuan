...
public class BreakpointsResumeUploadServer {
     ...
     * @throws Exception 
     */  
    public BreakpointsResumeUploadServer() throws Exception{
    	System.out.println("========== 初始化 BreakpointsResumeUploadServer ==========");
     ...
     * @throws Exception 
     */  
    public BreakpointsResumeUploadServer(int port) throws Exception{  
        try {  
    ...
    private void bingToServerPort(int port) throws Exception{  
        try {
        	ScheduledTimerListener ss = null;
    ...
    public void service(){
    	System.out.println("---------------开始启动BreakpointsResumeUpload server socket---------------");
    ...
    public static void main(String[] args) throws Exception{  
        new BreakpointsResumeUploadServer().service();  
    }  
