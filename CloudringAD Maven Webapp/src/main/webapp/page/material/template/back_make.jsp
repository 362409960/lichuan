...
<input type="hidden" name="imgae_url" id="imgae_url" />
...
<input type="hidden" name="videoPlace_url" id="videoPlace_url" />
 <input type="hidden" id="background_picture" name="background_picture" value="${template.virtual_path}"/>
...
function changeBg(_src){
	var oImage=new Image();
	oImage.src=_src;
	oImage.onload=function(){
		var oMain=document.getElementById('main');
		oMain.style.backgroundImage='url('+this.src+')';
		oMain.style.backgroundRepeat='repeat';
	};
}
changeBg("${template.virtual_path}");
</script>
</body>
</html>
<script type="text/javascript">
