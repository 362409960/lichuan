...
<body>
<form id="frm" name="frm" method="post"  action="" onkeydown="if(event.keyCode==13){return false;}">
...
<input type="hidden" name="pdf_url" id="pdf_url" value="${template.imgae_url}" />
...
<input type="hidden" name="context_video" id="context_video" />
<input type="hidden" name="play_time" id="play_time" value="${template.play_time}" />
<div id="EditDiv">
  <div class="Toolbar" style="padding:2px 4px 0;">
    <div id="div3" class="css_normal left">
      ...
      <img src="<%=path%>/images/sys/icon/tb_dock.gif" alt="|"> <span> <span>模板名称：</span>
       <span id="programName">
...
<script type="text/javascript" src="<%=path%>/js/template_add.js"></script>
