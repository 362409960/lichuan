	            	...
	            	<td valign="top">
	        			...
	        			<table align="center">
	        				<tr>
	                            ...
	                            <td><div class="generalbtt"><a id="generaltse" href="javascript:addChildMenu()" >增加子菜单</a></div></td>
	                           	<td><div class="generalbtt"><a id="generaltse" href="javascript:editMenu()" >修改菜单</a></div></td>
	                           	<td><div class="generalbtt"><a id="generaltse" href="javascript:deleteMenu()" >删除菜单</a></div></td>
	                   		</tr>
	                 	</table>
	            	</td>
	        	</tr>
