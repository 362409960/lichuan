...
<meta http-equiv="X-UA-Compatible" content="IE=edge" />
		...
		<meta name="copyright" content="SHOP++" />
			<meta name="keywords" content="手机数码" />
			<meta name="description" content="手机数码" />
		...
		<div class="hotGoods">
			<dl>
				<dt>热销商品</dt>
					<dd>
						<a href="#">
							<img src="http://www.cloudring.net/upload_cloudringshop/upload/20150918/055557ed641145d2956e5d39e1527c42.jpg" alt="模拟4寸红外迷你中速球" />
					...
					<dd>
						<a href="#">
							<img src="http://www.cloudring.net/upload_cloudringshop/upload/20150918/2b86092c4f974629b97d829a427bcf07.jpg" alt="云台" style="width: 172px; "/>
					...
					<dd>
						<a href="#">
							<img src="http://www.cloudring.net/upload_cloudringshop/upload/20150918/9df1fe98d0fd4c049fbba716986d4623.jpg"  style="width: 172px; " alt="SDI 全高清白色枪机" />
						...
						<li>
							<a href="<%=path %>/home/showShopIndex.do">首页</a>
							 ...
							 <c:choose>
						      ...
						      <c:otherwise>
							      <dd>
										<li><a href="<%=path %>/home/showShopHomeSecurity.do?type=1&skipName=${k.id}">${k.name}</a></li>
								</dd>
						      </c:otherwise>
								</c:choose>
								</c:forEach>
