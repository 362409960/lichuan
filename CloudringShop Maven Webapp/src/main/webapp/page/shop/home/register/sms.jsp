...
<div class="reg">
	<div id="main_container" class="reg-frame">
        ...
        <div>
        <form id="registerForm" action="<%=path %>/register/writPwd.do" method="post">
         <input type="hidden" id="phone" name="phone" value="${mobile}"/>
        	<div class="regbox">
            	<div class="reg-step">
                    <div class="inputbg">
                    	<label class="labelbox" for="" style="float:left;">
                        	 <input id="smscode" name="smscode" class="text" maxlength="6" placeholder="请输入短信验证码" style="width:130px;" />  
                        </label>
                         <span class="remain"><input type="button" id="btnSendCode" name="btnSendCode"  value="免费获取验证码" onclick="sendMessage()" /></span>
                    </div>
                    <div class="err-tip">
                    	<div class="err-box">
