...
<body> 
<div class="listinfo">
<form id="frm" name="frm" method="post" action="<%=path %>/admin/categories/updateMerchandiseCategories.do" target="_parent">
...
<tr>
	...
	<td class="shurukang_abv" width="310px">
		...
		<div class="geinputmid3">
		    <input type="text" name="name" value="${merch.name} "  onblur="showVerification()" id="name" class="required"/> 
		</div>
		</div>
		</div>
	</td>
...
<tr>
	...
	<td class="shurukang_abv" width="310px">
		...
		<div class="geinputright">
		<div class="geinputmid3">	
					<select id="pid"  name="pid" style="width:156px;"/>  
				</div>
		</div>
		</div>
	</td>
...
<tr>
	...
	<td class="shurukang_abv" width="310px">
		...
		<div class="geinputright">
		<div class="geinputmid3">
		    <input type="text" name="metaDescription" value="${merch.metaDescription}" id="metaDescription" class="required"/> 
		</div>
		</div>
		</div>
	</td>
...
<tr>
	...
	<td class="shurukang_abv">
		...
		<div class="geinputright">
		<div class="geinputmid3">
		    <input type="text" name="metaKeywords" value="${merch.metaKeywords}" id="metaKeywords"  maxlength="20" class="required"/>
		</div>
		</div>
		</div>
	</td>
...
<script type="text/javascript">
 ...
 $(function () {
        $('#pid').combotree
            ({ url: '<%=path %>/admin/categories/getJsonData.do',
                valueField: 'id',
                textField: 'text',
                required: false,
                editable: false,                         
                onLoadSuccess: function () {
                 $("#pid").combotree("setValue", me);                
                }
        });
    ...
    if(metaKeywords == null || metaKeywords == ''){
		...
		$.ajax({
		 url: "<%=path %>/admin/categories/updateMerchandiseCategories.do",
		 type: "POST",
		 cache:false,
		 async:true,
		 dataType: "json",
