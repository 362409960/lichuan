...
<body> 
<div class="listinfo">
<form id="frm" name="frm" method="post" enctype="multipart/form-data"  action="<%=path %>/admin/brand/updateMerchandiseBrand.do" target="_parent">
...
<tr>
	...
	<td class="shurukang_abv" width="310px">
		...
		<div class="geinputmid3">
		    <input type="text" name="name" value="${merch.name} "  onblur="showVerification()" id="name" /> 
		</div>
		</div>
		</div>
	</td>
...
<tr>
	...
	<td class="shurukang_abv" width="310px">
		...
		<div class="geinputright">
		<div class="geinputmid3" -->
		    <img  src="${merch.logo}" id="logo" style="display: block;width: 100px;height: 100px;">
		  <input type="file" name="logoPhoto"  size="30"  id="logophoto" onchange="showOpen()" accept="image/*"/>
		<!-- </div>
		</div>
		</div> -->
	</td>
...
<tr>
	...
	<td class="shurukang_abv">
		...
		<div class="geinputright">
		<div class="geinputmid3">
		    <input type="text" id="url" name="url" value="${merch.url}" id="metaKeywords"  maxlength="20"/>
		</div>
		</div>
		</div>
	</td>
...
var contextPath = "${pageContext.request.contextPath}";
    ...
    if(url == null || url == ''){
	 ...
	 $('#frm').form('submit',{
                url: contextPath+"/admin/brand/updateMerchandiseBrand.do",
               	onSubmit: function(){
