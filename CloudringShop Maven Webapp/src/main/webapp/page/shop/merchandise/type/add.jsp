...
<body> 
<div class="listinfo">
<form id="frm" name="frm" method="post" action="<%=path %>/admin/type/insertMerchandiseType.do" target="_parent">
...
<tr>
	...
	<td class="shurukang_abv" width="310px">
		<!-- <div class="geinputleft2">
		<div class="geinputright">
		<div class="geinputmid2">		 -->    	   
		    <input type="radio" name="isSignDisplay" value="0" id="is1" checked="checked"/>显示
...
<tr>
    <td align="center" style="font-weight:bold" >商品类型编码</td>
	<td class="shurukang_abv">
		<div class="geinputleft3">
		<div class="geinputright">
		<div class="geinputmid3">
		    <input type="text" name="productTypeSN" id="productTypeSN"  maxlength="20"/>
		</div>
		</div>
		</div>
	</td>
...
<script type="text/javascript">
    ...
    if(productTypeSN == null || productTypeSN == ''){
		...
		$.ajax({
		 url: "<%=path %>/admin/type/insertMerchandiseType.do",
		 type: "POST",
		 cache:false,
		 async:true,
		 dataType: "json",
