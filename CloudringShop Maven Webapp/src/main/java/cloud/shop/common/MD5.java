...
public class MD5
{
  ...
  public String getMD5ofStr(String inbuf){
	  if(inbuf == null)
		  System.out.print("fuck you mather !!!!!!!!!!!!!!!!!!!!!!!!!!!!  the  string is null ");
    md5Init();
    try{
      byte str[] = inbuf.getBytes("ISO8859_1");
      md5Update(str, str.length);
  ...
  public static String Md5(String plainText ) { 
	  ...
	  try { 
		  ...
		  System.out.println("result32: " + buf.toString());
	...
	public static void main(String[] args) {
		System.out.println(Md5("F://dfdewfd//dfefe/ere/fd.jpg"));  //c95e019ea87f88cea923cd3e206a74d7   c95e019ea87f88cea923cd3e206a74d7
	}
