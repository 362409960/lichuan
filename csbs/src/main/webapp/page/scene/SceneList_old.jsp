...
<div style="margin:20px 0;" align="center"></div>
  <div id="tb" align="center" style="width:80%; margin-bottom:10px; margin-left:100px;">
    ...
    -->
	<table id="dg" title="场景信息列表" style="width:100%;height:345px"
		...
		<thead>
			<tr>
                ...
                <!-- 
                    ...
                    分页功能的实现请根据对应的语言环境实现
   				-->
                <th data-options="field:'id',width:$(this).width()*0.08,align:'center'">编号</th>
				<th data-options="field:'EmpNum',width:$(this).width()*0.08,align:'center'">名字</th>
				<th data-options="field:'Name',width:$(this).width()*0.08,align:'center'">背景</th>
                <th data-options="field:'Status',width:$(this).width()*0.08,align:'center'">指令码</th>
                <th data-options="field:'IDCard',width:$(this).width()*0.13,align:'center'">设备编号</th>
                <th data-options="field:'InDate',width:$(this).width()*0.13,align:'center'">控制码</th>
                <th data-options="field:'SortCode',width:$(this).width()*0.08,align:'center'">设备状态</th>
	...
	<script type="text/javascript">
		...
		$(function(){
			...
			$dg = $('#dg');
			$dg.datagrid({
				url : contextPath+"/scene/jsonData",
				fit : true,
				pagination : true,
				pagePosition : 'bottom',
				pageSize : 50,
