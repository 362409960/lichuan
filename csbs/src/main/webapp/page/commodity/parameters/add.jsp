...
<body>
<div class="breadcrumb"><a href="<%=path%>/index.jsp">首页</a>&raquo;&nbsp;添加商品参数</div>
<form id="inputForm"  method="post" action="<%=path%>/admin/parameters/save.do">
	<table class="input">
    	<tr>
        	<th>绑定分类:</th>
            <td>
        ...
        <tr>
            ...
            <td><input type="text" name="para_name" class="text" value="" maxlength="200"></td>
        </tr>
        <tr>
        	<th>排序:</th>
        ...
        <tr>
            ...
            <td>
            	<table id="optionTable" class="item">
                    ...
                    <tr>
                    	<td>
                        	<input type="text" name="options" class="text" value="" maxlength="200">
                        </td>
                        <td>
