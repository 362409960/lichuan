...
<body>
<div class="breadcrumb"><a href="<%=path%>/index.jsp">首页</a>&raquo;&nbsp;添加规格</div>
<form id="inputForm"  method="post" action="<%=path%>/admin/specification/save.do">
	<table class="input">
    	<tr>
        	<th>绑定分类:</th>
            <td>
        ...
        <tr>
            ...
            <td><input type="text" name="group_name" class="text" value="" maxlength="200"></td>
        </tr>
        <tr>
        	<th>排序:</th>
