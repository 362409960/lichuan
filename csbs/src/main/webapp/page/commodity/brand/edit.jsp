...
<form id="inputForm"  method="post" action="<%=path%>/admin/band/edit.do" enctype="multipart/form-data">
<input type="hidden" name="id" id="id" value="${brand.id}"/>
	<table class="input">
    	<tr>
        	<th><span class="requiredField">*</span>名称：</th>
            <td><input type="text" name="brand_name" value="${brand.brand_name}" class="text" maxlength="200"></td>
        </tr>
        <tr>
        	<th>类型：</th>
            <td>
        ...
        <tr class="hidden">
				...
				<td>
					<span class="fieldSet">
						...
						<img  src="${brand.logo}" id="logo" style="display: block;width: 100px;height: 100px;">
      	...
      	<tr>
        	<th>网址：</th>
            <td><input type="text" name="url" class="text" value="${brand.url}" maxlength="200"></td>
        </tr>  
        <tr>
        	<th>排序：</th>
            <td><input type="text" name="order_value"  class="text" value="${brand.order_value}" maxlength="9"></td>
        </tr>
        <tr>
        	<th>介绍：</th>
            <td>
