...
$().ready(function() {
	...
	$("#productSelect").autocomplete(product, {	  
		dataType: "json",		
		max: 20,
		extraParams:{name:function(){return $('#productSelect').val();},type:"1"},
		width: 218,
		scrollHeight: 300,
		parse: function(data) {
...
<body>
	<div class="breadcrumb">
		<a href="<%=path%>/index.jsp">首页</a> &raquo; 入库
	</div>
	<form id="inputForm" action="<%=path%>/admin/invManag/save_in.do" method="post">
		...
		<table class="input">
			...
			<tr>
				...
				<td>
					<input type="text" name="inQuantity" class="text" maxlength="16" />
				</td>
			</tr>
			<tr>
				<th>
