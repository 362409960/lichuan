...
<form id="frm" name="frm" method="post" class="extendarea">
    ...
    <table border="0" cellpadding="0" cellspacing="0"  style="width:100%;table-layout:fixed;">
    	 <tr>
            ...
            <td>
               <div class="geinputleft"><div class="geinputright"><div class="geinputmid">
                	<input type="text" id="dic_code" name="dictionary.dic_code"  title="字典代码" onblur="checkUnique()" tip="字典代码" rules="required,string" maxlength="40" />
                </div></div></div>
            </td>
        ...
        <tr>
            ...
            <td>
                <div class="geinputleft"><div class="geinputright"><div class="geinputmid">
                 	<input type="text" id="dic_value" name="dictionary.dic_value" title="字典值" onblur="checkUniqueDicValue()"  tip="字典值" rules="required" maxlength="20" />
                 </div></div></div>
            </td>
            <td><span class="required">*</span></td>
            <td>(最长20位)</td>
        ...
        <tr>
            ...
            <td colspan="2">
            	<table width="100%" border="0" cellspacing="0" cellpadding="0">
                	<tr>
                		<td><textarea id="note" name="dictionary.note" rows="4" cols="34"  tip="说明" rules="text" maxlength="50"></textarea></td>
                		<td>(最长50个字)</td>
                	</tr>
                </table>
            </td>
...
function save(){
    if (checkUnique()&& checkUniqueDicValue()){
    	...
    	jQuery.ajax({
            url:"<s:url value="/admin/catalog/dictionary/insert.action" encode="false"/>",
            type:"POST",
            cache:false,
            async:false,
            dataType: "json",
