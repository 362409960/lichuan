...
<body>
	...
	<form id="catalogListForm" method="post">
		<table class="tableForm_L">
	        <tr>
	          	<th>字典分类代码</th>
	          	<td><input class="easyui-text" name="pkid" style="width: 150px;border:1px solid #eee;"></td>
				<th>字典分类名称</th>
	          	<td><input class="easyui-text" name="catalogName" style="width: 150px;border:1px solid #eee;"></td>
