...
<body>
<div class="breadcrumb"><a href="index.html">首页</a>&raquo;添加发货点</div>
<form id="inputForm" method="post" action="##">
  <table class="input">
    ...
    <tr>
      ...
      <td><input type="text" name="contact" class="text" maxlength="200" /></td>
    </tr>
    <tr>
    ...
    <tr>
      <th> 邮编: </th>
      <td><input type="text" name="zipCode" class="text" maxlength="200" /></td>
    </tr>
    <tr>
      <th> 电话: </th>
      <td><input type="text" name="phone" class="text" maxlength="200" /></td>
    </tr>
    <tr>
      <th> 手机: </th>
      <td><input type="text" name="mobile" class="text" maxlength="200" /></td>
    </tr>
    <tr>
      <th> 是否默认: </th>
